...
var myCtrl = myApp.controller('myCtrl', function($scope) {
	...
	$scope.membersArray = ["Adam Ku", "Steven Anderson", "Martin Mathay", "Sven Hansen", "Jason Waataja", "Sheng Yu", "Kevin Veith", "Nikolai Scheel", "Chris White", "Elizabeth Giacobbi", "Megan McCarthy"];
